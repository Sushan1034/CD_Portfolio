        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-12 lg:gap-20 text-center md:text-left">
          ...
          >
            <div className="relative w-40 h-40 md:w-56 md:h-56">
              ...
              <div className="relative w-full h-full rounded-full border-[6px] border-white dark:border-slate-800 shadow-2xl overflow-hidden">
                <img
                  src="/profile.JPG"
                  alt="Sushan Aryal"
          ...
          <div className="flex-1 max-w-2xl">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold text-slate-900 dark:text-white mb-4 tracking-tight leading-[1.1]">
                Sushan Aryal
              </h1>
              <p className="text-xl md:text-2xl font-medium text-blue-600 dark:text-blue-400 mb-6 tracking-tight">
