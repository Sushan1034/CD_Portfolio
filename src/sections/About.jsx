      ...
      <div className="section-container relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="relative overflow-x-auto pt-8 pb-6 md:pt-0 md:pb-0 hide-scrollbar">
              <div className="flex md:grid md:grid-cols-7 relative z-20 min-w-max md:min-w-0 h-32 md:h-16 gap-6 md:gap-0 px-6 md:px-0">
