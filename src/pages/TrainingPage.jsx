...
// Curated coding/cloud related placeholder videos that play immediately.
// Sushan can easily replace these placeholder URLs with his actual S3 URLs as noted below.
const instagramVideos = [
  {
    id: 1,
    title: "AWS Billing Alarms Tutorial",
    // REPLACE THIS URL WITH YOUR AWS S3 VIDEO URL, e.g., "https://your-bucket.s3.amazonaws.com/video1.mp4"
    src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4",
  },
  {
    id: 2,
    title: "VPC Subnetting Quick Tips",
    // REPLACE THIS URL WITH YOUR AWS S3 VIDEO URL, e.g., "https://your-bucket.s3.amazonaws.com/video2.mp4"
    src: "https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4",
  },
  {
    id: 3,
    title: "IAM Policies Explained",
    // REPLACE THIS URL WITH YOUR AWS S3 VIDEO URL, e.g., "https://your-bucket.s3.amazonaws.com/video3.mp4"
    src: "https://vjs.zencdn.net/v/oceans.mp4",
  },
  {
    id: 4,
    title: "DynamoDB Single-Table Design",
    // REPLACE THIS URL WITH YOUR AWS S3 VIDEO URL, e.g., "https://your-bucket.s3.amazonaws.com/video4.mp4"
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans selection:bg-blue-100 dark:selection:bg-blue-900 selection:text-blue-900 dark:selection:text-blue-50 relative overflow-x-hidden">
      ...
      <main className="relative z-10 max-w-6xl mx-auto px-6 pt-36 pb-24 space-y-24">
            ...
            {programDetails.map((prog, idx) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-450 dark:text-slate-500 font-bold uppercase tracking-wider mb-4">
                    {prog.level}
                  </p>
                  ...
                  <ul className="space-y-2 mb-8">
                    {prog.features.map((feat, fIdx) => (
                      <li key={fIdx} className="text-xs text-slate-650 dark:text-slate-400 flex items-start gap-2 leading-snug">
        ...
        {/* Instagram Content Creation Section (AWS S3 Hosted) */}
        <section className="space-y-12 bg-slate-100/40 dark:bg-slate-900/30 border border-slate-200/50 dark:border-slate-800/40 rounded-[3rem] p-8 md:p-12">
          <div className="text-center max-w-2xl mx-auto space-y-4">
            ...
            <p className="text-sm text-slate-600 dark:text-slate-450 leading-relaxed">
              Explore educational cloud architecture content and quick walkthroughs designed for social media, hosted securely on Amazon S3 storage.
            </p>
          </div>
              ...
              <div key={video.id} className="relative group bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl overflow-hidden shadow-sm flex flex-col justify-between">
                ...
                <div className="p-4 border-t border-slate-100 dark:border-slate-800/80 bg-white/70 dark:bg-slate-900/70 backdrop-blur-md">
                  ...
                  <p className="text-[10px] text-slate-400 dark:text-slate-500 font-bold uppercase mt-0.5 flex items-center gap-1">
                    <span className="w-1.5 h-1.5 rounded-full bg-blue-600" /> Served from S3
                  </p>
                </div>
              </div>
            ))}
